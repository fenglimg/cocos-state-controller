/**
 * StateSelect 挂载自动 opt-in 契约 (TASK-003).
 *
 * 行为变更: StateSelect.__preload 时, 若 getCurrCtrl() 返回有效 ctrl, 遍历 applicable prop
...
describe("StateSelect 挂载自动 opt-in (TASK-003)", () => {
    it("StateSelect 暴露 isApplicableProp 方法", () => {
