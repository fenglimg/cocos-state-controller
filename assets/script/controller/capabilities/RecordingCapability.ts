 ...
 *
 * Topic 3 录制路径 (T03-T17) 已实装在 StateController / StateSelect 内部.
 ...
 *   - snapshot 是 StateSelect 实例字段, 不需要 namespace
...
export const RecordingCapability: ICapability & {
    ...
    onStateWillChange(ctx: CapabilityContext): void {
        // 录制中切 state, Topic 3 的 StateSelect.onStateWillChange 已直接处理 diff commit,
