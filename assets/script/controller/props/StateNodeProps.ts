...
export class StateNodeProps {
    ...
    @property({ visible: false, displayName: "显示/隐藏 (Active)", tooltip: "控制节点的显示和隐藏状态" })
    ...
    @property({ visible: false, displayName: "位置 (Position)", tooltip: "节点的位置属性" })
    ...
    @property({ visible: false, displayName: "缩放 (Scale)", tooltip: "节点的缩放属性" })
    ...
    @property({ visible: false, displayName: "颜色 (Color)", tooltip: "节点的颜色属性" })
    ...
    @property({ visible: false, displayName: "尺寸 (Size)", tooltip: "节点的宽高尺寸" })
    public get propSize() {
    ...
    @property({ visible: false, displayName: "旋转 (Euler)", tooltip: "节点的旋转角度" })
    ...
    @property({ visible: false, displayName: "锚点 (Anchor)", tooltip: "节点的锚点位置" })
    ...
    @property({ visible: false, displayName: "透明度 (Opacity)", tooltip: "节点的透明度" })
